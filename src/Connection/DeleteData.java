    ...
    public static boolean deleteHoaDon(String MaHD) {
     ...
     public static boolean deleteBaoHanh(String MaBH) {
       ...
       public static boolean deleteKhuyenMai(String MaKM) {
        ...
        public static boolean delelteCT_KhuyenMai(String CTKM){
            String sqlCommand = "delete from dbo.CT_KhuyenMai where MaKM=?";
        try {
            DataConnection.createStatement();
            PreparedStatement ps = DataConnection.connection.prepareStatement(sqlCommand);
            ps.setString(1,CTKM);
     ...
     public static boolean deleteCT_PhieuDat(String MaPD){
            String sqlCommand = "delete from dbo.CT_PhieuDat where MaPhieuDat=?";
        try {
            DataConnection.createStatement();
            PreparedStatement ps = DataConnection.connection.prepareStatement(sqlCommand);
            ps.setString(1, MaPD);
